...
class numbers {
    private:
        int n1,n2;
    public:
        friend int calculator :: addfirstnumbers(numbers o1,numbers o2);
        friend int calculator :: addlastnumbers(numbers o1,numbers o2);
        friend int calculator :: addallnumbers(numbers o1,numbers o2);
